...
import com.velotn.entity.SignalGroup;
...
import static com.velotn.entity.Groups.getGroupe_courant;
...
public class SignalGroupService {
    ...
    public void ajouterSignal(SignalGroup s) {
        try {
            ...
            Logger.getLogger(com.velotn.service.SignalGroupService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                sendMail(emailAdress, emailSubject, emailBody);
    ...
    public boolean getSignal(int idU, int idG) {
        ...
        try {
            ...
            Logger.getLogger(com.velotn.service.PublicationGroupService.class.getName()).log(Level.SEVERE, null, ex);
        }
