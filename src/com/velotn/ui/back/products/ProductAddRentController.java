...
public class ProductAddRentController {
    ...
    void ajouter(ActionEvent event) {
        sp.insertL(new Accessoire(TF_nomProd.getText(), TF_description.getText(), Float.parseFloat(TF_prix.getText()), Integer.parseInt(TF_quantite.getText()), TF_marque.getText(), TF_type.getText(),NomImage.getText()));
    }*/
